...
هر تم باید یه موقعیت مرتبط با اتفاقات و سناریوهای محیط کار/شغل یا اتفاقات و سناریوهای محیط آکادمیک/دانشگاه برای پایه گفتگوهای مرتبط در هریک از موراد باشه که بشه صفت و فعل
آلمانی مرتبط باهاش یاد گرفت. تم‌ها رو از این دو دسته انتخاب کن:

۱) محیط کار و شغل: مکالمات کاری و اتفاقات روزمره‌ی محل کار.
۲) محیط آکادمیک و دانشگاه: مکالمات در کلاس درس، سمینار و ارائه، تحقیق و پروژه‌ی دانشگاهی، پایان‌نامه，
...
۱. **کلمه‌ی آلمانی** (Artikel در صورت نیاز)
   ...
   - ترجمه مثال به انگلیسی: ...
   - معادل  عبارت به انگلیسی: ...

حداقل ۵ صفت مرتبط بده.

📌 فعل‌ها (Verben):
همون فرمت بالا رو برای حداقل ۵ فعل مرتبط با تم بده (فعل‌ها رو با پیشوند/زمان حال ساده معرفی کن و بگو منظم هست یا نامنظم).
